...
modificação. Sendo um modulo referente a manutenção, também e possível
...
Aqui também e possível correr o agregador sobre o ficheiro de vendas.
...
\begin{itemize} 
    \item Um que trata da sincronização com a
        ...
        sempre atualizada.
    \item Um que contem a cache de preços.
    \item Um responsável pela comunicação e tratamento dos pedidos dos clientes
\end{itemize}
Toda a comunicação com o servidor e feita com recurso a \textit{Named pipes},
