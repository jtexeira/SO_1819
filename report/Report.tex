...
Servidor} e conhecimentos sobre o Sistema Operativo baseados em Unix. Como objetivo, 
é necessário implementar um sistema que permita a utilização concorrente de 
...
Este projeto tem como arquitetura três grandes módulos, sendo estes \textit{Cliente
de Vendas, Servidor de Vendas e Manutenção de artigos}.
